...
exports.setup = function setup(app) {
  ...
  // Serve the UTF grids
  app.get('/:surveyId/utfgrids*', tiles.renderGrids);

  // Serve the UTF grids for a filter
  app.get('/:surveyId/filter/:key/:val/utfgrids*', tiles.renderGrids);
  app.get('/:surveyId/filter/:key/utfgrids*', tiles.renderGrids);
};

...
exports.dbTimer = makeLatencyMetric('Component/Pipeline/Mongoose[ms|render]');
exports.processingTimer = makeLatencyMetric('Component/Pipeline/DataProcessing[ms|render]');
